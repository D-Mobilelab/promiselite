var runTests = function(PromiseLite, who){

	describe(who + ': Promises without executor', function(){

		it(who + ': should be resolved manually', function(){
		...
		it(who + ': should execute then-chains added before they\'re resolved', function(){
			var p = new PromiseLite();
		...
		it(who + ': should execute then-chains added after they\'re resolved', function(){
			var p = new PromiseLite();
		...
		it(who + ': should execute fail if then raises an error', function(){
			var p = new PromiseLite();
		...
		it(who + ': should throw an exception if then raises an error and there is no fail to catch it', function(){
			var p = new PromiseLite();
		...
		it(who + ': should throw an exception if fail raises an error and there is no other fail to catch it', function(){
			var p = new PromiseLite();
		...
		it(who + ': should execute correctly then/fail-chains', function(){
			var p = new PromiseLite();
	...
	describe(who + ': Promises with executor', function(){

		it(who + ': should be resolved automatically if resolve is invoked in the executor (synchronous function)', function(){
		...
		it(who + ': should be resolved automatically if resolve is invoked in the executor (asynchronous function)', function(done){
			var p = new PromiseLite(function(resolve, reject){
		...
		it(who + ': should be rejected automatically if reject is invoked in the executor (synchronous function)', function(){
			var p = new PromiseLite(function(resolve, reject){
				reject();
			});
		...
		it(who + ': should be rejected automatically if reject is invoked in the executor (asynchronous function)', function(done){
			var p = new PromiseLite(function(resolve, reject){
		...
		it(who + ': should throw an exception if the executor raises an error and there is no fail to catch it', function(){
	...
	describe(who + ': Promise.all', function(){

		it(who + ': should be resolved if all the promises are resolved', function(){
		...
		it(who + ': should be rejected if any of the promises are rejected', function(){
			var p1 = new PromiseLite();
			var p2 = new PromiseLite();
			var p3 = new PromiseLite();
	...
	describe(who + ': Promise.race', function(){

		it(who + ': should be resolved if the first promise settled is fulfilled', function(){
			var p1 = new PromiseLite();
			var p2 = new PromiseLite();
			var p3 = new PromiseLite();
		...
		it(who + ': should be rejected if the first promise settled is rejected', function(){
			var p1 = new PromiseLite();
			var p2 = new PromiseLite();
			var p3 = new PromiseLite();
	...
	describe(who + ': Promise.any', function(){

		it(who + ': should be resolved as soon as one promise is resolved', function(){
			var p1 = new PromiseLite();
			var p2 = new PromiseLite();
			var p3 = new PromiseLite();
		...
		it(who + ': should be rejected if all the promises are rejected', function(){
	...
	describe(who + ': Promise.force', function(){

		it(who + ': should be executed when the promise is resolved', function(){
		...
		it(who + ': should be executed when the promise is rejected', function(){
		...
		it(who + ': should be executed when a then raises an error', function(){
		...
		it(who + ': should be executed when a fail raises an error', function(){
		...
		it(who + ': should be executed in chain', function(){
